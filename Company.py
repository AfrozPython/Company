...
# import the model
pipe = pickle.load(open('C:/Users/Appu/Desktop/Streamlit Test/Best Code Streamlit/Z Test Programs/1000 companies/pipe.pkl','rb'))
df = pickle.load(open('C:/Users/Appu/Desktop/Streamlit Test/Best Code Streamlit/Z Test Programs/1000 companies/df.pkl','rb'))
